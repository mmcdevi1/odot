  ...
  describe "POST create" do 
    ...
    context "with no user found" do 
      ...
      it "sets the flash message" do 
        post :create, email: 'new@found.com'
  ...
  describe "PATCH update" do 
    context "with no token found" do 
      it "renders the edit page" do 
        patch :update, id: 'notfound', user: { password: 'newpass', password_confimation: 'newpass' }
        expect(response).to render_template('edit')
      end
    ...
    context "with a valid token" do 
      ...
      it "updates the users password" do 
        ...
        patch :update, id: user.password_reset_token, user: { password: 'newpass', password_confimation: 'newpass' }
        user.reload
